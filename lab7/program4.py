...
def compile_shaders():
    ...
    vertex_shader_source = """
        ...
        void main(void) {
            ...
            // InstanceID zmienna ktora przechowuje numer biezacej instancji
            int x_transform = gl_InstanceID / 10;
            int y_transform = gl_InstanceID % 10;
            
            // position pozycja wierzcholka w przestrzeni lokalnej
            // vec4 przesuwanie wierzcholka
            gl_Position = P_matrix * V_matrix * M_matrix * 
                (position + vec4(x_transform, y_transform, 0, 0));
